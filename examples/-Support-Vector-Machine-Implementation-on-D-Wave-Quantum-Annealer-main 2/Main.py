...
def parseArguments():
    ...
    parser.add_argument("--dataFile",default= 'banknote_2',help = 'Dataset File')
    parser.add_argument("--trainingPoints",type = int,default= 800,help = 'Training Points')
    parser.add_argument("--validationPoints",type = int,default= 200,help = 'validation Points')
    ...
    parser.add_argument('--fig',default=True,action='store_true',help = "Plot Figure")
...
def main():
    ...
    if args['fig']: utils.plot_figure(_SVM,alpha,data,t,b,args['trainingPoints'],args['type'],args['dataFile'])
